...
import * as propellant from '@/vue/src'
import * as propellantDocs from '@/vue/docs'

export default {
  name: 'app',
  components: { propDoc, DemoHeader },
  data() {
    return { components: propellant, docs: propellantDocs }
  }
}
</script>
...
header.docs { flex-direction: row; }
